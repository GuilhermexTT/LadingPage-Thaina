...
export default function HomeContent({
  ...
  // Initialize state with pre-fetched Sanity data, falling back to static local data if empty
          ...
          <div className="relative order-1 flex justify-center animate-fade-in">
            <div className="relative w-full max-w-lg aspect-[4/5] rounded-[2.5rem] overflow-hidden shadow-2xl border-2 border-gold/20">
              {siteConfig.heroImage && (
                <Image src={siteConfig.heroImage} alt="Dra. Thainá Carvalho" fill className="object-cover" priority />
              )}
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative group">
            <div 
              ...
              style={{ aspectRatio: siteConfig.aboutImageDimensions?.aspectRatio || '4/5' }}
            >
              {siteConfig.aboutImage && (
                <Image src={siteConfig.aboutImage} alt="Dra. Thainá atendendo" fill className="object-cover transition-transform duration-700 group-hover:scale-105" />
              )}
            </div>
          </div>
...
const proceduresData = [
  ...
  { niche: "facial", name: "Toxina Botulínica (Botox Full Face)", desc: "Suaviza lines de expressão e previne rugas, mantendo leveza e naturalidade." },
  ...
  { niche: "corporal", name: "Depilação a Laser", desc: "Tecnologia avançada para redução progressiva dos pelos, proporcionando mais conforto, praticidade e melhora da qualidade da pele. Indicado para diversas regiões do corpo, com resultados duradouros e seguros." }
];
